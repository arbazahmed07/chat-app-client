  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
     ...
     <form onSubmit={handleSubmit}>
      ...
      <Link to="/signup" className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block'>{"Don't"} have an accout?</Link>
...
//       </div>
//       <a href="#" className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block'>{"Don't"} have an accout?</a>
